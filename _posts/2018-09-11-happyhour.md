...
- 탑다운 형식으로 진행되는 일부 프로젝트에서도 해피아워가 유용했다. 결정권자가 없어 목표 세우기가 힘들기에 회고가 맞지 않았을 것 같다. 해피아워는 단합하긴 좋지만, 일 처리 자체에 도움이 되는지는 잘 모르겠다.
